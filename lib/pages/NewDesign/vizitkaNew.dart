...
class VizitkaNewScreen extends StatefulWidget {
  VizitkaNewScreen({Key? key}) : super(key: key);

  @override
  State<VizitkaNewScreen> createState() => _VizitkaNewScreenState();
}

class _VizitkaNewScreenState extends State<VizitkaNewScreen> {
  @override
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 30),
                    Text('Мои баллы:', style: TextStyle(
                        color: Colors.white,
                        fontSize: 40,
